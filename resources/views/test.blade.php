...
<html>
	...
	{!! Form::token();!!}
   	{!!Form::email('mail_to', 'Envoyé à',['class' => 'form-control input-md'])!!}<br>
   	{!!Form::email('mail_from', 'Ton mail',['class' => 'form-control input-md'])!!}<br>
   	{!!Form::text('file_description', 'Descriptif (facultatif)',['class' => 'form-control input-md'])!!}<br>
